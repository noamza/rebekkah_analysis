function S= get_zones(rate_mat, S)
        ...
        %% REMOVE PF_radius for muscimol analysis
        %%REINSERT FOR REST OF ANALYSIS!!! 
        ...
        %%FOR MUSICOL ANALYSIS. REMOVE TRY CATCH OTHERWISE
%         try
...
%         end
        ...
        %%
   %    REINSERT FOR NON_MUSICOL ANALYSIS
...
%         S.where = where;
        ...
        [size_auto, size_auto_y] = size(auto_max_inds);
        cen = 1:size_auto;
