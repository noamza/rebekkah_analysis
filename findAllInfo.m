function [fano_factor, norm_max_index, max_indices, ...
    ...
    number_zone_mat, zone_mat]= findAllInfo(pos_mean_x,pos_mean_y,pos_t,spk_x,spk_y,spk_t,rate_mat,autocorr)
...
[~, number_zone_mat_sm]= CreateZoneMat(size(rate_mat), PF_radius, max_inds, peak_rates);
[zone_mat, number_zone_mat]= CreateZoneMat(size(rate_mat_ns), PF_radius_ns, max_inds_ns, peak_rates_ns);
