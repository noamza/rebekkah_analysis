...
parms.dir_save_pictures='N:\users\rebekkah\final data smoothed\examine first five mins and last five mins\images';
parms.dir_save_data = 'N:\users\rebekkah\final data smoothed\examine first five mins and last five mins\results'; 
...
for cen = 1:max_inds_len-1
   for cen2= (cen+1):max_inds_len
    ...
    if peak_distance < 1.25*(Cell.PF_radius/2) 
     too_close (h,1) = cen;
     too_close(h,2) = cen2;
...
R.PF_radius = (0.65* Cell.PF_radius)/2; 
