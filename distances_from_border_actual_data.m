...
%   Detailed explanation goes here
    ...
    for i=1:length(file_names)
      ...
      %% finds distances  
        ...
        for cen = [1, size_x]
            for cen2 = 1:size_y
            max_peak_distance_top_bottom (1,h) = Distance(S.max_index(1, 1),S.max_index(1, 2), cen , cen2);
        ...
        for cen = [1, size_y]
            for cen2= 1:size_x
            max_peak_distance_right_left(1,h)= Distance(S.max_index(1, 1),S.max_index(1, 2), cen2 , cen);
...
save('distances PF 8 bin6 nonsmooth', 'distances');
