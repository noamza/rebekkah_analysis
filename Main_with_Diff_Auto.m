...
parms.dir_load_data = 'N:\users\rebekkah\final data smoothed\data sets\data set with no HD with circular rooms at least 7 PF';
%parms.dir_load_data2 = 'N:\users\rebekkah\final data smoothed\results with fitted box arena';
parms.dir_save_pictures='N:\users\rebekkah\final data smoothed\data sets\images WITH CIRCULAR ARENAS';
...
parms.dir_save_data = 'N:\users\rebekkah\final data smoothed\data sets\results WITH CIRCULAR ARENAS';
...
%        Cell.six_orientation_pts= S.six_orientation_pts;
       ...
       % if exist('S.six_orientation_pts') 
        ...
        if (bPrintPicture)
            ...
            arena_phi =0;
            [min_angle, main_axis, axis_and_orient] = adjusted_orientation_analysis(Cell.autocorr, rate_mat, Cell.six_orientation_pts, arena_phi ) ;
            ...
            %             subplot(n,m,1)
            %             [rotated_sq_x, rotated_sq_y] = draw_fitted_arena_box(file_name, parms.dir_load_data, Cell.smallest_degree);
            %
            ...
            strTitle= sprintf('smallest degree = %0.3f \n wall =%d \n new angle=%0.3f \n new wall=%d', ...
                smallest_degree, smallest_degree_wall, min_angle, axis_and_orient);
            title(strTitle);
