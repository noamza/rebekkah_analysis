...
load('half sessions G3MD15PF3 info results.mat',...
    'orig_rates_b','orig_rates_e','max_inds_b','max_inds_e')
...
for k= 1:shuffle_times
    ...
    save('shuffled split session firing stability analysis', ...
    'mean_corrs','mean_corrs2','mean_2D_corrs');

end


% actual mean corr= 0.4064
% actual mean corr2= 0.4184
