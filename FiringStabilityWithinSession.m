...
for i =1:len
   ...
   [all_corrs(i),all_corrs2(i), orig_rates_b{i},orig_rates_e{i},...
    ...
    rate_mats_e{i},rate_mats_b{i},zone_mats_begin{i},zone_mats_end{i}]= ...
...
save('half sessions G3MD15PF3 info results AGAIN', 'peak_rates_b', 'peak_rates_e',...
    'rate_mats_e', 'rate_mats_b', 'zone_mats_begin', 'zone_mats_end',...
    'all_corrs', 'all_corrs2','twoD_zone_corrs', ...
    'max_inds_b','max_inds_e','orig_rates_e','orig_rates_b');
